...
int tagandprobe() {
    ...
    //--------------------------------------------------------------------------------------
    TFile *file = new TFile("../Trees081215/DYJetsToLL_M-50-LO_tpzee_2015.root");
    //TFile *file = new TFile("../Trees081215/SingleElectron-2015D_tpzee_2015.root");
    ...
    TString EtaBins[2] = {"EtaLt1p48", // Barrel
                          "EtaGt1p48" // Endcap
                         };
...
//    TH1F *eta_probe=new TH1F("eta_probe","",100,-2.5,2.5);
    ...
    for (int i = 0; i < tree->GetEntries(); ++i) {
        tree->GetEntry(i);
        if(id_1>0.5 && iso_1<0.15 && pt_1>23 && fabs(eta_1)<2.1 && trigger_match_1 && fabs(dxy_1) < 0.045 && fabs(dz_1) < 0.2) {
        ...
        //and eta cuts, possible dxy and dz cuts and trigger matching
            ...
            if(id_2>0.5 && iso_2<0.15 && pt_2>23 && fabs(eta_2)<2.1 && trigger_match_2 && fabs(dxy_2) < 0.045 && fabs(dz_2) < 0.2) {
